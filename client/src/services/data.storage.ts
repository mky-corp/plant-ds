...
export const maped = [
  ...
  'Moho de hoja de tomate: El moho de la hoja del tomate es causado por el patógeno Passalora fulva. Se encuentra en todo el mundo, predominantemente en tomates cultivados donde la humedad relativa es alta, particularmente en invernaderos de plástico.',
